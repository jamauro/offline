 ...
 */
const config = {
  filter: { deleted: false }, // filter the documents to keep across all collections. Recommended: use soft deletes, if you're using a different flag for your soft deletes, you'll want to change this.
